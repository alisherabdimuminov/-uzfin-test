...
def print_selected_tests(modeladmin: ModelAdmin, request: HttpRequest, queryset: QuerySet):
    th = tuple(["Talabgarnining F.I", "Mutaxasislik", "To'plagan bali", "To'g'ri javoblar", "Texnik nosozlik sababli qo'shilgan ball", ])
    td = []
    ...
    with pdf.table(col_widths=(30, 30, 10, 10, 20)) as table:
